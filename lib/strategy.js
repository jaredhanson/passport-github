...
function Strategy(options, verify) {
  ...
  this._userProfileEmailsURL = options.userProfileEmailsURL || 'https://api.github.com/user/emails';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  var strategy = this;
  strategy._oauth2.get(strategy._userProfileURL, accessToken, function (err, body, res) {
    var json;
    ...
    if (!json.email || json.email == '') {
      strategy._oauth2.get(strategy._userProfileEmailsURL, accessToken, function (err2, body2, res2) {
        if (err2) { //user:email not added to scope!...
