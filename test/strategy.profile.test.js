...
describe('Strategy#userProfile', function() {
  ...
  describe('fetched from custom endpoint', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      ...
      var body = '{ "login": "octocat", "id": 1, "name": "monalisa octocat", "email": "octocat@github.com", "html_url": "https://github.com/octocat", "avatar_url": "https://github.com/images/error/octocat_happy.gif" }';
      callback(null, body, undefined);
    };
